  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <main className="pb-16">
        {/* Hero Section */}
        <section className="relative px-6 pt-24 pb-32 flex flex-col items-center text-center bg-gradient-to-b from-teal-50 to-slate-50">
          ...
          <div className="w-full max-w-2xl relative shadow-xl rounded-full flex items-center bg-white p-2">
            <Search className="text-slate-400 ml-4 absolute pointer-events-none" size={24} />
            <input 
              type="text" 
              placeholder="Search for restaurants, sports, sunsets..." 
              className="w-full py-4 pl-14 pr-32 rounded-full outline-none text-slate-700 text-lg"
            />
            <button className="absolute right-2 bg-teal-700 hover:bg-teal-800 text-white px-6 py-3 rounded-full font-medium transition-colors shadow-md">
              Explore Now
            </button>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="px-6 py-16 max-w-5xl mx-auto mt-12">
          <div className="bg-teal-800 rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <button className="bg-white text-teal-800 font-bold px-8 py-3.5 rounded-full hover:bg-teal-50 hover:scale-105 transition-all shadow-lg">
                  Get Listed Today
                </button>
                <button className="bg-teal-600 border border-teal-500 text-white font-bold px-8 py-3.5 rounded-full hover:bg-teal-500 hover:scale-105 transition-all">
                  Learn More
                </button>
              </div>
            </div>
